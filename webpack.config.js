...
const exportConfig = function (env, config = {}) {
  ...
  const package =
    config.web && process.env && process.env.HIPLOT_PACKAGE ? process.env.HIPLOT_PACKAGE : "hiplot";
...
module.exports = [
  ...
  (env) => {
    ...
    const installToFolders = [
      ...
      path.resolve(__dirname, "npm-dist", "streamlit_component"),
    ];
    installToFolders.forEach(function (sc) {
      installs[path.resolve(sc, "streamlit_component", "hiplot_streamlit.bundle.js")] =
        "hiplot_streamlit.bundle.js";
      installs[path.resolve(sc, "streamlit_component", "index.html")] =
        "../src/index_streamlit.html";
      installs[path.resolve(sc, "hiplot.bundle.js")] =
        env && env.test ? "hiplot_test.bundle.js" : "hiplot.bundle.js";
    });
